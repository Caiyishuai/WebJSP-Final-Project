...
<script src="js/jquery.dialog.js"></script>
	...
	<%  
    if((request.getAttribute("is_success"))!=null)
    {
		String ok =(String)request.getAttribute("is_success");
    	//System.out.println("ok!!"+ok);
			if(ok.equals("1")){
		%>
			<script>
			alert('恭喜你选课成功！');
			  /*$.sendSuccessToTop('恭喜你选课成功！', 3000, function() {
		...
		<script>
		alert('对不起，你已选过这门课');
			  /*$.sendWarningToTop('对不起，你已选过这门课', 3000, function() {
...
<jsp:include page="menuStu.jsp?col=3" flush="true"/>
	...
	<div class="content" style="border:0px solid #000;float:none;display:block;height:100%">
				...
				<td>
				<a href="Choose.do?action=ins&Sno=<%=user %>&Cno=<%=cou.getCno()%>">
					<img src="images/choose.png" width=30>
				</a>
				</td>
				</tr>
				<%
