...
<%
	...
	for(int i=0;i<cookie.length;i++){
		...
		if(c1.getName().equals("username")){
			uname = URLDecoder.decode(c1.getValue(),"UTF-8");
		}
	}
%>
<head>
		...
		<div class="formBox level-login">
			...
			<div class="box loginBox">
				...
				<form class="form1" action="login.do?action=in" method="post">
					<div class="f_row-2">
						<input type="text" class="input-field" placeholder="学号/工号" name="username" required>
					</div>
					<div class="f_row-2 last">
						<input type="password" name="userpass" placeholder="密码" class="input-field" required>
					</div>
					<!-- 记住用户名,打钩就会返回value的值 -->
					<input type="checkbox" name="remember" value="1">记住用户名和密码<br>
					<input class="submit-w3" type="submit" value="登录啦！">
					<input class="submit-w3" value="注册" onclick="window.location.href='register.jsp'">
					<div class="f_link">
						<a href="" class="resetTag">居然忘了密码?</a>
					</div>
				</form>
			</div>
